...
public class AutoLineView extends ViewGroup {
	...
	public AutoLineView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.AutoLineView);
		horizontalSpace = ta.getDimension(R.styleable.AutoLineView_horizontalSpace, 0);
		vertivalSpace = ta.getDimension(R.styleable.AutoLineView_vertivalSpace, 0);
		ta.recycle();
