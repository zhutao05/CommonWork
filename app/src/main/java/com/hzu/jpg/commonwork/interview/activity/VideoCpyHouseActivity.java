...
public class VideoCpyHouseActivity extends AppCompatActivity {
    ...
    static class MyHandler extends Handler {
        WeakReference<VideoCpyHouseActivity> weakReference;

        MyHandler(VideoCpyHouseActivity activity) {
            weakReference = new WeakReference<VideoCpyHouseActivity>(activity);
        }

        public void handleMessage(Message msg) {
            final VideoCpyHouseActivity activity = weakReference.get();
            if (activity != null) {
                switch (msg.what) {
                    case 1:
    ...
    private void init() {
        ...
        companyToken=intent.getStringExtra("companyToken");
        studentId=intent.getStringExtra("studentId");
        Log.e(TAG,"companyToken="+companyToken);

        videoProgressView.setVisible(View.VISIBLE);
        videoProgressView.setText("正在加载...");
    ...
    private void initPlayer() {
        ...
        localStream.addObserver(new StreamObserver() {
            ...
            public void error(Errors errors) {
                ...
                VideoCpyHouseActivity.this.finish();
            }
    ...
    private synchronized void initSession() {
        session=cat.createSession(companyToken, Session.SessionType.P2P);
        ...
        thread = new Thread() {
            ...
            public void run() {
                ...
                while (thread_flag) {
                    ...
                    synchronized (VideoCpyHouseActivity.class) {
