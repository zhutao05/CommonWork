...
public class JobMsgAdapter extends BaseRvAdapter <JobMsg>{
    ...
    public JobMsgAdapter(Context context, List<JobMsg> data) {
        super(Config.CONTEXT, R.layout.item_apply_jobs,data);
        this.context = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, final JobMsg item) {
